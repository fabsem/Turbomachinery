...
m_lieblein_tip = lieblein_mcoeff(TIPfp.beta3,profile);%0.26;
m_lieblein_mid = lieblein_mcoeff(MIDfp.beta3,profile);%0.25;
m_lieblein_hub = lieblein_mcoeff(HUBfp.beta3,profile);%0.23;
